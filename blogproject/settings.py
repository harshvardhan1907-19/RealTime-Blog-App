...
AUTHENTICATION_BACKENDS = [
    'blogapp.backends.EmailOrUsernameBackend', # Custom backend (username OR email)
    'django.contrib.auth.backends.ModelBackend' # Default fallback
    # Without this setting, Django doesn't know about our custom authentication method.
]
